...
var setup = (node, unsubs, opts) => {
  ...
  const changeMode = (newMode) => {
    ...
    if (newMode === 2) {
      ...
      relativeOffset = prevMode === 0 ? Math.max(0, scrollPaneOffset + latestScrollY - naturalTop + offsetTop) : Math.max(
        0,
        scrollPaneOffset + latestScrollY + viewPortHeight - (naturalTop + nodeHeight + offsetBottom)
      );
      if (bottom) {
...
var StickyBox = (props) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { className, style, ref, children });
};
