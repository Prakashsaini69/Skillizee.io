      ...
      <div className="flex flex-col gap-4 h-full">
        <div className="absolute top-20 left-4 z-50">
          <Button
            ...
            className="mt-4 p-2 border rounded-md max-w-[200px] bg-white text-black hover:bg-gray-100"
          >
            Click
        ...
        <div className="absolute top-4 right-4 z-50">
          <div className="flex flex-col gap-1">
            <Badge variant="outline" className="bg-white text-black">prev - {blobState.previousSize}</Badge>
            <Badge variant="outline" className="bg-white text-black">cur - {blobState.size}</Badge>
          </div>
        </div>
