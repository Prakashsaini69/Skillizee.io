...
const plans = [
  {
    icon: (
      <svg width="40" height="40" fill="none" viewBox="0 0 40 40"><rect width="40" height="40" rx="12" fill="#3B82F6"/><path d="M28 13v14a2 2 0 0 1-2 2H14a2 2 0 0 1-2-2V13a2 2 0 0 1 2-2h12a2 0 0 1 2 2Z" fill="#fff"/><path d="M16 11v2M24 11v2" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round"/></svg>
    ),
    name: "LITE",
