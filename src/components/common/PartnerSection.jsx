...
export default function PartnerSection() {
  return (
    <section className="w-full bg-[#0039A6] relative py-6 sm:py-8 px-4 sm:px-2 md:px-0 flex justify-center items-center overflow-hidden">
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-center gap-6 md:gap-0 mx-auto relative z-10">
        ...
        <div className="bg-white rounded-md shadow-lg flex flex-col md:flex-row items-center justify-center px-8 sm:px-12 md:px-20 py-4 gap-4 sm:gap-6 md:gap-12 w-full md:w-auto">
