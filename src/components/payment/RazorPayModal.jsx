...
const RazorPayModal = ({ isOpen, onClose, courseData }) => {
  ...
  const handlePaymentSubmit = async () => {
    await handlePayment(formData, 
      // Success callback
      (onboardData) => {
        console.log('🎉 Payment and onboarding successful!');
      ...
      // Error callback
      (errorMessage) => {
        console.error('❌ Payment or onboarding failed:', errorMessage);
      }
    );
  };
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div>
              <h2 className="text-xl font-bold text-gray-900">Enroll in {course.name}</h2>
